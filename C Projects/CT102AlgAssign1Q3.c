...
int main() {
	...
	FILE *fptr = fopen("/Users/oisinmcl/Downloads/5000intsUnsorted.txt", "r");
...
void bubbleSort(int arrA[], int size) {
    ...
    printf("\nBubble Sort of UNSORTED INTS: Time taken is %lf seconds\n", timeTaken/CLOCKS_PER_SEC);
    printf("\nBubble Sort of UNSORTED INTS Swaps: %d\n", swaps);
    printf("\nBubble Sort of UNSORTED INTS Comparrisons: %d\n\n", compar);
}
...
void selectionSort(int arrA[], int size) {
    ...
    timeTaken = clock() - time;
    printf("\nSelection Sort of UNSORTED INTS: Time taken is %lf seconds\n", timeTaken/CLOCKS_PER_SEC);
    printf("\nSelection Sort of UNSORTED INTS Swaps: %d\n", swaps);
    printf("\nSelection Sort of UNSORTED INTS Comparrisons: %d\n", compar);
}
...
void insertionSort(int arrA[], int size) {
    ...
    timeTaken = clock() - time;
    printf("\nInsertion Sort of UNSORTED INTS: Time taken is %lf seconds\n", timeTaken/CLOCKS_PER_SEC);
    printf("\nInsertion Sort of UNSORTED INTS Swaps: %d\n", swaps);
    printf("\nInsertion Sort of UNSORTED INTS Comparrisons: %d\n", compar);
} //return
...
void countSortRange(int arrA[], int size, int minVal, int maxVal) {
    ...
    timeTaken = clock() - time;
    printf("\nCount Sort of UNSORTED INTS: Time taken is %lf seconds\n", timeTaken/CLOCKS_PER_SEC);
    printf("\nCount Sort of UNSORTED INTS Swaps: %d\n", swaps);
    printf("\nCount Sort of UNSORTED INTS Comparrisons: %d\n", compar);
}